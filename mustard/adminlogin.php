...
<div class="form">
<center><h3 class="panel-title">Admin Login Form</h3></center>
<form class="form-horizontal" role="form" method="POST" action="adminlogin.php">
 ...
 <button type="submit" class="btn btn-success" value="login" name="admin_login">Admin Login</button>
...
if(isset($_POST['admin_login']))//this will tell us what to do if some data has been post through form with button.
{
    ...
    if(mysqli_num_rows($run_query))
    {
       ...
       # $_SESSION['email']=$admin_email;//here session is used and value of $user_email store in $_SESSION.
    }
